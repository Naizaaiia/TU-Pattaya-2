...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<table border='1'>
			...
			<tr>
				...
				<td><a href="DeleteHistTH.php?id=<?php echo $row[0]?>">Delete</a></td>
				<td><a href="EditOneHistTH.php?id=<?php echo $row[0]?>">Edit</a></td>
			</tr>
			<?php }?>
		</table>
		<form action="AddOneHistTH.php" method="post">
		<br>
