<?php	
	...
	$sql="insert into softth(Header1,Header2,Header3,Header4,Header5,Header6,Detail1,Detail2,Detail3,Detail4,Detail5,Image) values('$Header1','$Header2','$Header3','$Header4','$Header5','$Header6','$Detail1','$Detail2','$Detail3','$Detail4','$Detail5','$Image')";
