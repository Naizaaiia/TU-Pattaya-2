<?php
	...
	$sql="select * from login where id=$idSelect";
...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<form method="post" action='EditTwoLogin.php' enctype="multipart/form-data">
			<input type="hidden" value="<?php echo $row["id"]?>" name='id_select'/>
		
			Enter Your username:<input type="text" name='username' value='<?php echo $row['username']?>'><br><br>
			Enter Your password:<input type="text" name='password' value='<?php echo $row['password']?>'><br><br>
			<br>
