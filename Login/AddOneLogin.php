...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
	...
	<body>
		<form method="post" action='AddTwoLogin.php' enctype="multipart/form-data">
		
			Enter Your username:<br><textarea rows="8" cols="50" type="text" name='username'></textarea><br><br>
			Enter Your password:<br><textarea rows="8" cols="50" type="text" name='password'></textarea><br><br>
			<br>
			<br><br>
